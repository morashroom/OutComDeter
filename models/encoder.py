...
from models.base import LSTM, get_sent_masks, selfAttention, MatchAttention, MatchAttention_concat
...
class CoAttnEncoder(BaseEditNLEncoder):
    def __init__(self,
        ...
        self.attention_layer = selfAttention(8, self.enc_hidden_size *2, self.enc_hidden_size *2)
        self.matchattention_layer = MatchAttention(512,512)
    ...
    def forward(self, code_tensor_a, code_tensor_b, action_tensor, code_lens, src_tensor, src_lens, *args):
        ...
        edit_ctx_encodings, src_ctx_encodings = self.matchattention_layer(c_edit_encodings, c_src_encodings)
        ...
        edit_encodings = self.attention_layer(edit_encodings)
